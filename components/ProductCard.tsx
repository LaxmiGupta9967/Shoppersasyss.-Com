  ...
  return (
    ...
    >
      <div className="relative h-48 bg-gray-200">
        ...
        <div className="absolute bottom-2 left-2 bg-black/60 backdrop-blur-sm text-white text-xs px-2 py-1 rounded-md flex items-center gap-1 shadow-sm max-w-[85%]">
      ...
      <div className="p-4 flex-grow flex flex-col">
        <h3 className="text-md font-medium text-gray-800 group-hover:text-primary transition-colors flex-grow line-clamp-2">{product.title}</h3>
