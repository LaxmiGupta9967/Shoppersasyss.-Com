...
import { StarIcon, PencilIcon, TrashIcon, HeartIcon, BriefcaseIcon } from './IconComponents';
...
interface UserProfileProps {
  ...
  // New callbacks for dashboard actions
  onEditProfile?: () => void;
...
const DashboardButton: React.FC<{ icon: React.FC<React.SVGProps<SVGSVGElement>>, label: string, onClick?: () => void, variant?: 'primary' | 'danger' | 'warning' | 'pink' }> = ({ icon: Icon, label, onClick, variant = 'primary' }) => {
    const variants = {
    ...
    return (
        <button
            onClick={onClick}
            className={`flex flex-col items-center justify-center p-4 rounded-xl border transition-all duration-200 transform hover:-translate-y-1 shadow-sm hover:shadow-md ${variants[variant]}`}
        >
                ...
                <aside className="lg:col-span-1 space-y-8">
                    <div className="bg-white rounded-xl shadow-lg overflow-hidden relative">
                        ...
                        <div className="bg-gradient-to-br from-orange-50 via-white to-white p-8 pb-16 text-center">
                            <img src={profileUser.avatar} alt={profileUser.name} className="w-32 h-32 rounded-full mx-auto ring-4 ring-white shadow-md object-cover" />
                            ...
                            {isOwnProfile && (
                                <button onClick={onEditProfile} className="mt-4 text-sm text-blue-600 hover:text-blue-800 font-medium flex items-center justify-center gap-1 mx-auto">
                ...
                <main className="lg:col-span-2">
                    ...
                    {isOwnProfile && (
                        <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 mb-8">
                            <h2 className="text-xl font-bold text-gray-900 mb-4">My Dashboard</h2>
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                ...
                                {currentUser.accountType === 'business' && (
                                    <DashboardButton 
                                        ...
                                        onClick={onGoToBusinessDashboard} 
                                        variant="warning"
                                    />
                                )}
                                <DashboardButton 
